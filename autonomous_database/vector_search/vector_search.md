...
1. Create Legislation Table and Trigger
    ...
    ```
    <copy>
	Create table vector.legislation 
	...
	create or replace editionable trigger vector.trg_legislation_vector_ocigenai 
	...
	alter trigger vector.trg_legislation_vector_ocigenai disable;
    </copy>
    ```
2. Create Legislation Vector Table
    ...
    ```
    <copy>
	create table vector.legislation_vector 
